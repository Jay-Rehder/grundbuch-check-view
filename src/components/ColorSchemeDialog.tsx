  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <div className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer w-full">
          <div className="flex items-center space-x-3">
            <Palette className="h-5 w-5 text-gray-600" />
            <span className="text-gray-700 font-medium">Schema ändern</span>
          </div>
        </div>
      </DialogTrigger>
